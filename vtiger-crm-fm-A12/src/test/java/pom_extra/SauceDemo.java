...
//		WebElement firstName =cop.getFirstName();
//		WebElement lastName =cop.getLastName();
//		WebElement postalCode =cop.getPostalCode();
//		WebElement continueBtn=cop.getContinueBtn();
		cop.setValues();
